...
#### 🔴 Запуск экспорта лога в lickhouse (Exporter):
   ...
   * как служба Windows/Linux. 
   Для теста в Вашей среде, достаточно просто выполнить конфигурацию приложения в файле *appsettings.json*, установить **runtime .net 5** (при его отсутствии) и запустить exe/dll. Базы данных в СУБД вручную создавать не нужно, они будут **созданы автоматически**.
...
Ничего в драйвере настраивать не нужно.
...
[см. Преобразование ссылки в UUID и обратно](./ПолучениеUUIDссылки.os)